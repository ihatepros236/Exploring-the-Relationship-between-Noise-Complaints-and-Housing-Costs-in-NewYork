---
title: "rent_index_a2020_general_all_income"
...
df_lma2020 <- rent_data_mod_a2020%>%filter(outlier==0)%>%select(filter_columns)
lma2020 <- lm(zillow_rent_value_index ~ ., data=df_lma2020)
...
```{r}
df_lma2020_opt <- rent_data_mod_a2020%>%filter(outlier==0)%>%filter(!var_zip %in% c("_11249","_11430"))%>%select(c(sel_columns_lma2020[!grepl("var_zip|^month|*Intercept*",sel_columns_lma2020)],var_zip,month,zillow_rent_value_index,zillow_month_day))

lma2020_opt <- lm(zillow_rent_value_index ~ .-zillow_month_day, data=df_lma2020_opt)
